...
public interface BoletaPagoRepository extends JpaRepository<BoletaPago, Integer>  {
	...
	@Query(value ="select e.cuit, b.aporte, a.descripcion as aporteDescripcion, d.periodo, b.importe, b.interes, "
			...
			+ "	   getboletapago_secuencia_pagofecha(e.cuit, a.codigo, b.secuencia, a.entidad) as fechaDePago, "
			+ "	   getboletapago_secuencia_pagoimporte(e.cuit, a.codigo, b.secuencia, a.entidad) as importeRecibido, "
			+ "	   b.baja_en as baja "
			+ "from boleta_pago b "
			+ "	inner join ddjj d on d.id = b.ddjj_id "
