...
public interface UsuarioPersonaRepository extends JpaRepository<UsuarioPersona, Integer>{
	...
	@Query("SELECT NEW ar.ospim.empleadores.nuevo.dominio.UsuarioInternoBO( U.id, U.descripcion, U.habilitado, U.ultimoLogin, U.previoLogin, UP.nombre, UP.apellido, UP.email, UP.notificaciones  ) " + 
